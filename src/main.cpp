...
int main(void)
{
    ...
    glfwSwapInterval(1); // permet de set la rapiditer de la fenetre avec la valeur par defaut de lecran je crois

    /* Charger les fonctions opengl avec glad et glfw */
